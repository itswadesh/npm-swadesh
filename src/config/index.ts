...
export const HTTP_ENDPOINT =
  env.PUBLIC_LITEKART_API_URL || 'https://api.litekart.in'
...
export const BIG_COMMERCE_STORE_HASH =
  env.PUBLIC_BIG_COMMERCE_STORE_HASH || 'ftelcymxrh'
...
export const slotMarginGeneralWithHelloBarAndHyperLocal =
  'mt-[114px] sm:mt-[206px]'
