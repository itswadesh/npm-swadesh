...
const toast = (title: any, type: any) => {
  title =
...
export const generatePriceRange = (price_stats: any, currencySymbol: any) => {
  let priceRange: any = []
    ...
    if (priceGap) {
      ...
      if (price1 >= 0 && price2 && price3 && price4 && price5) {
        priceRange = [
          ...
          {
            from: price1,
            key: `From ${currency(price1, currencySymbol)} to ${currency(
              price2,
              currencySymbol
            )}`,
            to: price2
          ...
          {
            from: price2,
            key: `From ${currency(price2, currencySymbol)} to ${currency(
              price3,
              currencySymbol
            )}`,
            to: price3
          ...
          {
            from: price3,
            key: `From ${currency(price3, currencySymbol)} to ${currency(
              price4,
              currencySymbol
            )}`,
            to: price4
          ...
          {
            from: price4,
            key: `From ${currency(price4, currencySymbol)} to ${currency(
              price5,
              currencySymbol
            )}`,
            to: price5
...
export const getIdFromYoutubeVideo = (url: string) => {
  if (!url) return 'XXX'
  const regExp =
...
export const shopifyInit = async ({ query, variables }: any) => {
  try {
    // @ts-ignore
