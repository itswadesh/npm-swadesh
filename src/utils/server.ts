...
export const getBigcommerceApi = async (
  endpoint: string,
  query?: any,
  sid?: any
) => {
  try {
    const response = await fetch(
      BIG_COMMERCE_BASE_URL + '/' + endpoint + '?' + serialize(query),
      {
...
export const postBigCommerceApi = async (
  endpoint: string,
  query: any,
  sid?: any
) => {
...
export const postShopifyApi = async (
  endpoint: string,
  data: any,
  sid?: any
) => {
...
export const getWoocommerceApi = async (
  endpoint: string,
  query?: any,
  sid?: any
) => {
...
export const postWoocommerceApi = async (
  endpoint: string,
  query: any,
  sid?: any
) => {
